...
export interface SectionPanditWidget extends Struct.ComponentSchema {
  collectionName: 'components_section_pandit_widgets';
  info: {
    displayName: 'PanditWidget';
  };
  attributes: {
    ShowPanditWidget: Schema.Attribute.Boolean;
  };
}
...
export interface SharedRelatedAarti extends Struct.ComponentSchema {
  collectionName: 'components_shared_related_aartis';
  info: {
    displayName: 'RelatedAarti';
  };
  attributes: {
    aartis: Schema.Attribute.Relation<'oneToMany', 'api::aarti.aarti'>;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'section.pandit-widget': SectionPanditWidget;
